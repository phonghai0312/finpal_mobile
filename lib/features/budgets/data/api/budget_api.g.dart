...
class _BudgetApi implements BudgetApi {
  ...
  Future<BudgetListResponseModel> getBudgets({
    ...
    final _options = _setStreamType<BudgetListResponseModel>(
    ...
    late BudgetListResponseModel _value;
    try {
      _value = BudgetListResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
